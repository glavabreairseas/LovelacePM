...
paneller.Solid.line_midpoint.__doc__ = (
    """line_midpoint(ind): returns midpoint for line of signed index ind"""
)
...
paneller.Solid.plotgeometry.__doc__ = (
    """plotgeometry(): plots solid\'s panelling using a pyqtgraph view widget"""
)
...
paneller.Solid.panel_calcSn.__doc__ = (
    """panel_calcSn(p): recalculates area and normal vector for panel p"""
)
...
utils.Mstreamtouni.__doc__ = (
    """Mstreamtouni(a, b): returns the inverse of utils.Mtostream(a, b)"""
)
...
utils.PG_inv_xmult.__doc__ = (
    """PG_inv_xmult(beta, a, b): returns the inverse of PG_xmult"""
)
...
__init__
"""
control.control_DOF.__init__.__doc__ = (
    """__init__(): initializes control_DOF instance with zero deflection"""
)
...
wing.wing.set_aircraft.__doc__ = (
    """set_aircraft(acft): sets the wing\'s bound aircraft to acft"""
)
...
"""
body.Re2e5.__doc__ = (
    """Re2e5(Re): simplest possible turbulence criterion (returns Re>2e5)"""
)
...
is provided"""
aircraft.aircraft.plotgeometry.__doc__ = (
    """plotgeometry(): plots the aircraft\'s panelling with a pyqtgraph view widget"""
)
